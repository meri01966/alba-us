...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      {/* Globito flotante de chat con Direccion (estilo WhatsApp) */}
      {salaActual && (
        <button
          type="button"
          onClick={() => setChatMaestraAbierto(true)}
          className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 shadow-lg flex items-center justify-center transition-transform hover:scale-105"
          aria-label="Chat con Direccion"
        >
